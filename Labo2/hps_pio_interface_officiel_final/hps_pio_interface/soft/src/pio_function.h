...
#define PIO_CORE0_BASE_ADD         0xFF200100  // Base address pour PIO0 (LEDs et switches)
#define PIO_CORE1_BASE_ADD         0xFF200120  // Base address pour PIO1 (HEX displays)
// ACCESS MACROS
...
#define PIO_DIRECTION_OFFSET       0x4      
#define PIO_OUTSET_OFFSET          0x10    
#define PIO_OUTCLEAR_OFFSET        0x14      

// Register access using macros
#define PIO0_DATA                  PIO0_REG(PIO_DATA_OFFSET)
#define PIO0_DIRECTION             PIO0_REG(PIO_DIRECTION_OFFSET)
#define PIO0_OUTSET                PIO0_REG(PIO_OUTSET_OFFSET)
#define PIO0_OUTCLEAR              PIO0_REG(PIO_OUTCLEAR_OFFSET)
#define PIO1_DATA                  PIO1_REG(PIO_DATA_OFFSET)
#define PIO1_DIRECTION             PIO1_REG(PIO_DIRECTION_OFFSET)
#define PIO1_OUTSET                PIO1_REG(PIO_OUTSET_OFFSET)
#define PIO1_OUTCLEAR              PIO1_REG(PIO_OUTCLEAR_OFFSET)

// Define PIO bits usage
#define LEDS_MASK                  0x3FF  
#define HEXS_MASK                  0x0FFFFFFF
#define SWITCHES_MASK              0x00003FF0
#define KEY_MASK 				   0x0000000F

//INIT
#define LEDS_INIT 0x155
#define HEX_INIT 0x010FC000
...
// Switch Masks
#define SWITCH_3_0 0xF
#define SWITCH_7_4 0xF0
#define SWITCH_7_0 (SWITCH_7_4 | SWITCH_3_0)
#define SWITCH_9_8 0x300

// Leds Mask
#define LEDS_7_0 0x0FF
...
// direction_init function : Initialize the direction of a PIO core
...
//Read_hex function : Read the hexadecimal value of a 7-segment
// Parameter: "seg7_number"= select the 7-segments number, from 0 to 3
// Return : The value
